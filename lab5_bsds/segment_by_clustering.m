...
function my_segmentation = segment_by_clustering( rgb_image, ...
    feature_space, clustering_method, num_k, im_size)
...
switch clustering_method
    ...
    case 'gmm'
%         obj = gmdistribution.fit(Ivector,num_k,'MaxIter',20,'Options',options);
        obj = fitgmdist(Ivector,num_k,'Options',options,'RegularizationValue',eps);
